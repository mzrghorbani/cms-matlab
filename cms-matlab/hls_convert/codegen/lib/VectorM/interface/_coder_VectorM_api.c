...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *phiS, const
  char_T *identifier);
 ...
 * Return Type  : void
 */
void VectorM_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                 *plhs[1])
{
  real_T (*m)[2];
  real_T phiS;
...
/*
 * File trailer for _coder_VectorM_api.c
 *
 * [EOF]
 */
