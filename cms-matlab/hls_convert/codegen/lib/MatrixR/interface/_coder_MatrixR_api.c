...
static real_T (*e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *St,
  ...
  const char_T *identifier))[8]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(St), &thisId);
                 ...
                 *plhs[1])
{
  ...
  St = e_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "St");
