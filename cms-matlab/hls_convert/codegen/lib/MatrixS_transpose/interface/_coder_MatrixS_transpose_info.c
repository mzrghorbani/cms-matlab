 ...
 * File: _coder_MatrixS_transpose_info.c
 *
...
/* Include Files */
#include "_coder_MatrixS_transpose_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("MatrixS_transpose"));
  emlrtSetField(xEntryPoints, 0, "NumberOfInputs", emlrtMxCreateDoubleScalar(1.0));
  emlrtSetField(xEntryPoints, 0, "NumberOfOutputs", emlrtMxCreateDoubleScalar
                (1.0));
  emlrtSetField(xEntryPoints, 0, "ConstantInputs", xInputs);
  emlrtSetField(xEntryPoints, 0, "FullPath", emlrtMxCreateString(
    "/home/eepgmmg1/Documents/matlab_projects/hls_convert/MatrixS_transpose.m"));
...
/*
 * File trailer for _coder_MatrixS_transpose_info.c
 *
 * [EOF]
 */
