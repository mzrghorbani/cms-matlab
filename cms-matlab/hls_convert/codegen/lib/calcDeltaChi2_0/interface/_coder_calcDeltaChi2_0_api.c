 ...
 * File: _coder_calcDeltaChi2_0_api.c
 *
 ...
 * Return Type  : void
 */
  void calcDeltaChi2_0_api(const mxArray * const prhs[2], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*res)[2];
  real_T (*RmatInv)[4];
  ...
  dChi2_0 = calcDeltaChi2_0(*res, *RmatInv);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(dChi2_0);
}
 ...
 * Return Type  : void
 */
void calcDeltaChi2_0_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calcDeltaChi2_0_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calcDeltaChi2_0_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_calcDeltaChi2_0_api.c
 *
 * [EOF]
 */
