 ...
 * File: _coder_calcDeltaChi2_info.c
 *
...
/* Include Files */
#include "_coder_calcDeltaChi2_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("calcDeltaChi2"));
  emlrtSetField(xEntryPoints, 0, "NumberOfInputs", emlrtMxCreateDoubleScalar(2.0));
  emlrtSetField(xEntryPoints, 0, "NumberOfOutputs", emlrtMxCreateDoubleScalar
                (1.0));
  emlrtSetField(xEntryPoints, 0, "ConstantInputs", xInputs);
  emlrtSetField(xEntryPoints, 0, "FullPath", emlrtMxCreateString(
    "/home/eepgmmg1/Documents/matlab_projects/hls_convert/calcDeltaChi2.m"));
...
/*
 * File trailer for _coder_calcDeltaChi2_info.c
 *
 * [EOF]
 */
